...
def main():
    ...
    for epoch in range(epoch_size):
        data_style_A, data_style_B = shuffle_data( data_style_A, data_style_B)  # image
        ...
        for i in range(n_batches):
            ...
            AB = generator_B(A)     # 새로운 image가 생성된다.
            BA = generator_A(B)
            ...
            A_dis_real, A_feats_real = discriminator_A( A ) # 진짜
            A_dis_fake, A_feats_fake = discriminator_A( BA )    # 가짜
